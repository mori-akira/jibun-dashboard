<template>
  <header
    class="fixed flex justify-between z-[1002] pt-[0.8rem] pb-[0.2rem] items-center w-screen bg-white border-b-2 border-[#666] translate-y-[-8px] inset-x-0"
  >
    <div
      :class="[
