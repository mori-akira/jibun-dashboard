  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.fileUploadMockPut(body, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["FileApi.fileUploadMockPut"]?.[
...
export const FileApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    fileUploadMockPut(body: File, options?: any): AxiosPromise<string> {
      return localVarFp
        .fileUploadMockPut(body, options)
     ...
     * @throws {RequiredError}
     */
    getUploadUrl(fileId?: string, options?: any): AxiosPromise<UploadUrl> {
      return localVarFp
...
export type GetQualificationSortKeyEnum =
  (typeof GetQualificationSortKeyEnum)[keyof typeof GetQualificationSortKeyEnum];
...
export const ResourceApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getI18n(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<LocaleCode>
    > {
...
export const ResourceApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getI18n(localeCode: string, options?: any): AxiosPromise<LocaleCode> {
      return localVarFp
...
export const SalaryApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    deleteSalary(salaryId: string, options?: any): AxiosPromise<void> {
      return localVarFp
     ...
     * @throws {RequiredError}
     */
    getSalaryById(salaryId: string, options?: any): AxiosPromise<SalaryId> {
      return localVarFp
     ...
     * @throws {RequiredError}
     */
    putSalary(salary?: Salary, options?: any): AxiosPromise<SalaryId> {
      return localVarFp
...
export const SettingApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getSetting(options?: any): AxiosPromise<Setting> {
      return localVarFp
        .getSetting(options)
        .then((request) => request(axios, basePath));
    },
     ...
     * @throws {RequiredError}
     */
    putSetting(setting?: Setting, options?: any): AxiosPromise<void> {
      return localVarFp
...
export const UserApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    postPassword(password?: Password, options?: any): AxiosPromise<void> {
      return localVarFp
     ...
     * @throws {RequiredError}
     */
    putUser(user?: User, options?: any): AxiosPromise<void> {
      return localVarFp
